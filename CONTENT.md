...
- 농업용 AI 로봇 응용 및 실습 프로그램 경진대회 장려상 · 2024.07 · 주관: 서울대학교 대학연대 지역인재양성 사업단 · AI 로봇 응용 실습 기반 경진대회에서 과제 수행 성과를 인정받아 수상
...
- 학력(석사): 농업기계공학과, 국립순천대학교 대학원 · 2025.02 졸업. 학위논문: 딥러닝 알고리즘을 이용한 객체 탐지 기술 연구
- 학력(학사): 농업기계공학과, 국립순천대학교
